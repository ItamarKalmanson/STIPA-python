...
def calculate_rt60(filepath):
    ...
    מבוסס על מדידת זמן הדעיכה מ--5dB ועד -25dB (הכפלה ב-3).
    """
    try:
        ...
        idx_minus_25 = np.argmin(np.abs(edc_db - (-25)))
...
input_folder = r"C:\Users\itama\OneDrive\מסמכים\GitHub\STIPA-python\STIPA-recs\STIPA recs simulations\EchoThief"         # התיקייה שבה נמצאות כל ההקלטות המקוריות שלך
output_folder = r"C:\Users\itama\OneDrive\מסמכים\GitHub\STIPA-python\STIPA-recs\STIPA recs simulations\all_reverbs_folder"  # התיקייה החדשה שאליה הקבצים יועתקו
